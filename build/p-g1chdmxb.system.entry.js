        ...
        execute: function () {
            ...
            var BubbleItem = exports('bubble_item', /** @class */ (function () {
                ...
                Object.defineProperty(class_1, "style", {
                    get: function () { return ".hide{display:none!important}:host{font-family:cargoD,Trebuchet MS,Arial,sans-serif}.bubble{border-radius:50%;position:absolute;background:#2b28c4;bottom:0;left:calc(50% - 100px);top:auto;-webkit-transition:opacity .3s ease;transition:opacity .3s ease;opacity:1;cursor:pointer;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center}.bubble-point{color:#fff;text-align:center}.bubble.burst{opacity:0}"; },
                    enumerable: true,
                    configurable: true
                });
                return class_1;
