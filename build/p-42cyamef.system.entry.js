    ...
    return {
        ...
        execute: function () {
            ...
            var GameItem = exports('game_item', /** @class */ (function () {
                ...
                class_2.prototype.checkLuckyProduct = function (_product) {
                    ...
                    if (_product) {
                        ...
                        setTimeout(function () { _this.showLuckyPopup = false; }, 2500);
                        // Save lucky coupon
            ...
            var PopupModel = exports('popup_model', /** @class */ (function () {
                ...
                class_4.prototype.popupModelQuit = function () {
            ...
            var RedeemPoint = exports('redeem_panel', /** @class */ (function () {
                ...
                class_5.prototype.render = function () {
                    var _this = this;
                    return (h("div", { class: "redeem-panel" }, h("div", { class: "redeem-point" }, "Points : ", h("span", { class: "" }, this._userData.points)), h("tab-panel", { ref: function (el) { return _this._tabPanel = el; } }), h("div", { class: "product-section" }, h("div", { class: "title" }, "You can use coupon code in below product also"), (function () {
