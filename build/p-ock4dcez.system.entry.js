...
System.register(['./p-9c067a18.system.js'], function (exports) {
    'use strict';
        ...
        execute: function () {
            ...
            function loadProductJson(url) {
                ...
                return fetch(url)
                    ...
                    .then(function (d) {
                    localStorage.setItem("pr_feed", JSON.stringify(d));
                });
                // .then(response => {
            ...
            function getProducts(limit) {
                ...
                var _products = JSON.parse(localStorage.getItem("pr_feed"));
            ...
            var RedeemPoint = exports('redeem_panel', /** @class */ (function () {
                ...
                class_5.prototype.onNavigatedHandler = function (e) {
            ...
            var TabPanel = exports('tab_panel', /** @class */ (function () {
                ...
                class_7.prototype.initTabPanel = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
            ...
            var VaUtil = exports('va_util', /** @class */ (function () {
                ...
                class_8.prototype.componentWillLoad = function () {
                    ...
                    if (this.dataSrc) {
                        ...
                        console.error("data-src has not been configured properly, please contact author.");
                    }
                };
                // //After rendering
                // componentDidLoad() {
