        ...
        execute: function () {
            ...
            var BubbleItem = exports('bubble_item', /** @class */ (function () {
                ...
                class_1.prototype.componentDidLoad = function () {
                    this.bubbleEl.style.left = randomIntFromInterval(1, 85) + '%';
                ...
                Object.defineProperty(class_1, "style", {
                    get: function () { return ".hide{display:none!important}:host{font-family:cargoD,Trebuchet MS,Arial,sans-serif}.bubble{border-radius:50%;position:absolute;background:#2b28c4;bottom:0;left:calc(50% - 100px);top:auto;-webkit-transition:opacity .3s ease;transition:opacity .3s ease;opacity:1;cursor:pointer;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;-webkit-box-shadow:inset -25px -25px 40px rgba(0,0,0,.3);box-shadow:inset -25px -25px 40px rgba(0,0,0,.3)}.bubble-point{color:#fff;text-align:center}.bubble.burst{opacity:0}"; },
                    enumerable: true,
                    configurable: true
                });
                return class_1;
            ...
            var GameItem = exports('game_item', /** @class */ (function () {
                ...
                class_2.prototype.bubbleDisappearedHandler = function () {
                ...
                class_2.prototype.render = function () {
                    var _this = this;
                    return [
                        h("div", { class: "score" }, h("audio", { src: "assets/media/poped.mp3", ref: function (el) { return _this.popedAudioTag = el; }, class: "hide" }), h("span", { class: "score-label" }, "POINTS"), h("span", { class: "score-text" }, this.score)),
                        h("button", { class: (this.isPaused ? "paused" : "") + " pause-btn", onClick: this.pauseGame.bind(this) }, "Pause"),
                        h("div", { class: (this.isPaused ? "paused" : "") + " game-item", ref: function (el) { return _this.gameElement = el; } }),
                        (function () {
                            if (_this.isPaused) {
            ...
            var RedeemPoint = exports('redeem_panel', /** @class */ (function () {
                ...
                class_5.prototype.render = function () {
                    var _this = this;
                    return (h("div", { class: "redeem-panel" }, h("div", { class: "redeem-point" }, "Points : ", h("span", { class: "" }, this._userData.points)), h("tab-panel", { ref: function (el) { return _this._tabPanel = el; } }), h("div", { class: "product-section" }, h("div", { class: "title" }, "You can use coupon code in below product also"), this.dataUpdated && this.productJson.map(function (productItem) { return h("div", { class: "product-item" }, h("a", { href: productItem.url, target: "_black", onClick: function () { return _this.btnClicked.emit(); } }, h("img", { src: productItem.image, title: productItem.name, alt: productItem.name }), h("span", null, productItem.name))); })), h("nav-item", null)));
                };
