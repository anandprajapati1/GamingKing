    ...
    return {
        execute: function () {
            ...
            var loadModule = function (cmpMeta, hostRef, hmrVersionId) {
                ...
                var module$1 = moduleCache.get(bundleId);
                if (module$1) {
            ...
            var patchEsm = exports('a', function () {
                ...
                if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
                    // @ts-ignore
                    return module.import('./p-dac3e2f0.system.js');
                }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            // @ts-ignore
                            return [4 /*yield*/, module.import('./p-bcae8885.system.js')];
                        case 2:
                            // @ts-ignore
                            _a.sent();
                            _a.label = 3;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, module.import('./p-8b2adfa7.system.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
                        case 3:
                            style_1 = _a.sent();
                            _a.label = 4;
                        case 4:
