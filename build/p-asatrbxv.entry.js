...
const TabPanel = class {
    ...
    render() {
        return (h("div", { class: "tab-panel" }, h("ul", { class: "tab-panel-navigation" }, this.tabs.map(item => h("li", { "data-link": item.tid, class: (this.activePanel == item.tid ? "active" : "") + " tab-panel-item", onClick: this.tabClicked.bind(this, item.tid) }, item.title))), h("div", { class: "tab-panel-container" }, this.tabs.map(el => h("div", { "data-tab-id": el.tid, class: (this.activePanel == el.tid ? "open" : "") + " tab-panel-content" }, el.tid == 1 ?
            ...
            h("div", { class: "previous-coupon" }, h("ul", null, h("li", null, h("div", { class: "heading serial-number" }, "Sl"), h("div", { class: "heading coupon-code" }, "Coupons Code"), h("div", { class: "heading coins" }, "Rewards")), this._userData.couponList.length ? this._userData.couponList.map((couponCoin, index) => h("li", null, h("div", { class: "serial-number" }, index + 1), h("div", { class: "coupon-code" }, couponCoin.code), h("div", { class: "coins" }, couponCoin.reward.coin > 0 ? couponCoin.reward.coin :
