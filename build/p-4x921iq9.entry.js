...
const GameItem = class {
    ...
    static get style() { return ".hide{display:none!important}:host{display:block}.game-item.game-playing:before{content:\"\";position:absolute;left:0;top:0;width:100%;height:100%;display:block;background:hsla(0,0%,100%,.9);padding:10px;border-radius:10px;-webkit-box-sizing:border-box;box-sizing:border-box;box-shadow:inset 0 0 35px 15px #5f1f64;-webkit-box-shadow:inset 0 0 5px 3px #5f1f64;z-index:-1}.score{position:relative;width:calc(100% - 20px);height:auto;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-pack:center;justify-content:center;z-index:5;margin:10px}.score .score-label,.score .score-text{color:#fff;font-family:cargoD,Trebuchet MS,Arial,sans-serif;font-size:20px;padding:0 5px;color:#5f1f64}\@media (min-width:992px){.score .score-label,.score .score-text{font-size:20px}}.life{position:absolute;left:0;top:0;width:100px;-ms-flex:0 0 100px;flex:0 0 100px}.life>span{display:inline-block;width:20%;height:20px;border-radius:50%;border:1px solid #d2264e;-webkit-box-sizing:border-box;box-sizing:border-box;overflow:hidden}.life>span:before{content:\"\";background:#d2264e;display:block;width:0;height:20px;-webkit-transition:width .3s ease;transition:width .3s ease}.life.life-1>span:first-child:before,.life.life-2>span:first-child:before,.life.life-2>span:nth-child(2):before,.life.life-3>span:first-child:before,.life.life-3>span:nth-child(2):before,.life.life-3>span:nth-child(3):before,.life.life-4>span:first-child:before,.life.life-4>span:nth-child(2):before,.life.life-4>span:nth-child(3):before,.life.life-4>span:nth-child(4):before,.life.life-5>span:first-child:before,.life.life-5>span:nth-child(2):before,.life.life-5>span:nth-child(3):before,.life.life-5>span:nth-child(4):before,.life.life-5>span:nth-child(5):before{width:100%}.pause-overlay{z-index:7}.pause-btn{background:url(https://anandprajapati1.github.io/shipDeploy/assets/img/close.png);background-size:contain;cursor:pointer;border:0;padding:0;z-index:9999;width:25px;height:25px;text-indent:9999px;position:absolute;right:10px;top:10px}\@media (min-width:768px){.pause-btn{width:30px;height:30px}}\@media (min-width:992px){.pause-btn{width:40px;height:40px}}.level-start-anim{visibility:hidden;width:100px;height:100px;padding:22px;position:absolute;left:50%;top:50%;border-radius:50%;background:#c5e86c;-webkit-box-shadow:0 0 10px 0 rgba(0,0,0,.5);box-shadow:0 0 10px 0 rgba(0,0,0,.5);font-size:50px;color:#fff;-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);-webkit-transition:all 1s ease;transition:all 1s ease;opacity:0}.level-start-anim.show{visibility:visible;-webkit-transform:translate(-50%,-50%) scale(1.5);transform:translate(-50%,-50%) scale(1.5);opacity:1}.pause-overlay{background:rgba(0,0,0,.75);-webkit-box-sizing:border-box;box-sizing:border-box;width:100%;height:100%;display:-ms-flexbox;display:flex;text-align:center;position:absolute;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center}.pause-overlay button{width:50px;height:50px;border-radius:50%;display:inline-block;margin:0 15px}"; }
};
