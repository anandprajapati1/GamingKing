...
System.register(['./p-e6f9ecb1.system.js', './p-4a817b49.system.js'], function (exports) {
    'use strict';
    var registerInstance, createEvent, h, enumModuleState, getUserData, UUID, setUserData;
    return {
        ...
        execute: function () {
            ...
            var PopupModel = exports('popup_model', /** @class */ (function () {
                ...
                class_2.prototype.onGameOver = function () {
            ...
            var RedeemPoint = exports('redeem_panel', /** @class */ (function () {
                ...
                class_3.prototype.onCouponPurchased = function () {
                    this._userData = getUserData();
                };
                //Before rendering
            ...
            var TabPanel = exports('tab_panel', /** @class */ (function () {
                ...
                class_4.prototype.pointSelected = function (_pt) {
                ...
                // Tab clicked
                class_4.prototype.tabClicked = function (val) {
                    this.activePanel = val;
                    this.btnClicked.emit();
                };
                class_4.prototype.createCoupon = function () {
                    var uuid = UUID();
                ...
                class_4.prototype.refreshScore = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            this._userData = getUserData();
                            return [2 /*return*/];
            ...
            var VaUtil = exports('va_util', /** @class */ (function () {
                 ...
                 */
                class_5.prototype.initMyComponent = function () {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/];
                        });
                ...
                class_5.prototype.toggleState = function () {
                ...
                // componentDidUnload() {
                // }
                class_5.prototype.popupOpenTrigger = function () {
                    // call pop up show/hide function
                    this.popupElement.openPopup();
                    this.btnClicked.emit();
                };
                class_5.prototype.btnClickedPlay = function () {
